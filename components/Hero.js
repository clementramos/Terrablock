...
export default function Hero() {
  return (
    <div className="flex flex-row justify-center items-start bg-black overflow-hidden bg-hero bg-no-repeat w-screen pt-24 xs:pt-48 xs:inline-block xs:bg-hero xs:w-full">
